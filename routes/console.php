...
Artisan::command('make:service-impl-controller {param}', function ($param) {
    $serviceInterfaceDirectory = app_path("Http/Controllers");
    ...
    if (!File::exists($serviceInterfaceDirectory)) {
        ...
        $serviceInterfaceContent .= "namespace App\Http\Controllers;\n\n";
        $serviceInterfaceContent .= "use App\Http\Services\\{$param}Service;\n\n";
    ...
    $serviceInterfaceContent .= "use App\Http\\Services\\{$param}Service;\n";
    $serviceInterfaceContent .= "use App\Http\Controllers\Controller;\n";
